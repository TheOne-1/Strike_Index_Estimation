...
basename = "out4"
master_df_ave.to_csv(f"Misc_tools\\data\\{basename}_ave.csv")
master_df_max.to_csv(f"Misc_tools\\data\\{basename}_max.csv")
master_df_min.to_csv(f"Misc_tools\\data\\{basename}_min.csv")
...
plt.savefig("Misc_tools\\figs\\Done\\SubSufficiently.png", bbox_inches='tight')
plt.show()

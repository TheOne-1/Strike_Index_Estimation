...
import numpy as np
from const import SUB_NAMES, MAIN_DATA_PATH
...
path_to_sub_stats = MAIN_DATA_PATH + "\\SubjectInfo.csv"
path_to_correlations_folder = "..\\strike_index_zach\\result_conclusion"
correlations_file = "predict_result_conclusion_RealziesSigmoid.csv"
path_to_discrete_results = "..\\strike_index_zach\\results"
...
if __name__ == "__main__":
    ...
    # save_name = "figs\\all_scatter.png"
    # # save_name = None
    ...
    marker_types = ["ok"]
    zipped_discrete_results = zip(discrete_results_types, marker_types)
    save_name = "figs\\all_scatter_percent.png"
    # save_name = None
    fig1(zipped_discrete_results, legend_entries, save_name)
    ...
    # zipped_discrete_results = zip(discrete_results_types,marker_types)
    # save_name = "Zach_figs\\figs\\speeds_scatter.png"
    # # save_name = None
    # fig1(zipped_discrete_results, legend_entries, save_name)
    ...
    # save_name = "Zach_figs\\figs\\Speed_Bar.png"
    # fig3(discrete_results_types, legend_entries, save_name)
    ...
    # discrete_results_types = ["_24","_28","_Minim", "_Trad"]
    # save_name = "Zach_figs\\figs\\Strike_Hist.png"
    # save_name = None

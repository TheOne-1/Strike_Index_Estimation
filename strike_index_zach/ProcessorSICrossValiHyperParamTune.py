...
class ProcessorSICrossVali(ProcessorSI):
    def __init__(self, sub_and_trials, imu_locations, sensor_sampling_fre, strike_off_from_IMU=True, do_input_norm=True, do_output_norm=True):
        super().__init__(sub_and_trials, None, imu_locations, strike_off_from_IMU, split_train=False, do_input_norm=do_input_norm, do_output_norm=do_output_norm)
